 ...
 */
 ...
 function get_template_A_info(user_info) {
  ...
  str += user_info.email;
  str += '<br/>';
  str += is_valid_data(user_info.InfoAd1) ? (user_info.InfoAd1.startsWith('http') ? '<a href="' + user_info.InfoAd1 + '">' + user_info.InfoAd1 + '</a><br/>' : '<br style="line-height: 10px" /><p>' + user_info.InfoAd1 + '</p>') : "";
  str += is_valid_data(user_info.InfoAd2) ? (user_info.InfoAd2.startsWith('http') ? '<a href="' + user_info.InfoAd2 + '">' + user_info.InfoAd2 + '</a><br/>' : '<br style="line-height: 10px" /><p>' + user_info.InfoAd2 + '</p>') : "";
  ...
  str +='<a href="https://pucmm.edu.do/" ><img src="https://pucmm.edu.do/PublishingImages/firma-addin/banner.png" width="600" height="70" alt="Banner PUCMM"> </a>';
