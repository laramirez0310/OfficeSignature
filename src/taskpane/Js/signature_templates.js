...
function get_template_A_str(user_info)
{
  ...
  str += user_info.email;
  str += '<br/>';
  str += is_valid_data(user_info.InfoAd1) ? '<p>' + user_info.InfoAd1 + '</p><br/>' : "";
  str += is_valid_data(user_info.InfoAd2) ? (user_info.InfoAd2.startsWith('http') ? '<a href="' + user_info.InfoAd2 + '">' + user_info.InfoAd2 + '</a><br/>' : '<p>' + user_info.InfoAd2 + '</p><br/>') : "";
  str += is_valid_data(user_info.InfoAd3) ? '<a href="' + user_info.InfoAd3 + '">' + user_info.InfoAd3 + '</a><br/>' : "";
  ...
  console.log("signature_templates " + str);
  return str;
}
